...
@endphp
    <section class="page-header page-header--bg-two" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
        <div class="privacy_policy page-header__bg jarallax-img"></div><!-- /.page-header-bg -->
    ...
    <section class="accrodion-one">
        <div class="container">
                <div class="section-title  text-center">
                    ...
                    <h2 class="section-title__title">We prioritize and respect your privacy through our transparent and secure privacy policy</h2>
                </div><!-- section-title -->
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to {{ env('APP_NAME', 'Laravel App') }}.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to {{ env('APP_NAME', 'Laravel App') }}, accessible from <a href="{{ env('APP_URL', 'https://example.com/') }}" rel="external nofollow noopener" target="_blank">{{ env('APP_URL', 'https://example.com/') }}</a></p>
</li>
<li>
...
<ul>
<li>
<p>By email: {{$ContactSetting->email ? $ContactSetting->email :''}}</p>
</li>
<li>
<p>By visiting this page on our website: <a href="{{ env('APP_URL', 'https://example.com/') }}conatct" rel="external nofollow noopener" target="_blank">{{ env('APP_URL', 'https://example.com/') }}conatct</a></p>
</li>
<li>
<p>By phone number: {{$ContactSetting->phone ? $ContactSetting->phone :''}}</p>
</li>
<li>
<p>By mail: {{$ContactSetting->location ? $ContactSetting->location :''}}</p>
</li>
</ul>
        </div>
    </section>
